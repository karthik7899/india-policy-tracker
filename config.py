...
STOCK_WATCHLIST = {   'aerospace_defence': [   {   'analyst_count': 24,
                             ...
                             {   'analyst_count': 8,
                                 ...
                                 'ticker': 'ASTRAMICRO'}],
    'big_cap_industries': [   {   'analyst_count': 31,
    ...
    'clean_energy': [   {   'analyst_count': 24,
                        ...
                        {   'analyst_count': 8,
                            ...
                            'ticker': 'ADANIGREEN'}],
    'cybersecurity': [   {   'analyst_count': 43,
                         ...
                         {   'analyst_count': None,
                             ...
                             'target_median': None,
                             'ticker': 'QUICKHEAL'}],
    'data_center_support': [   {   'analyst_count': 2,
    ...
    'fmcg': [   {   'analyst_count': 26,
                ...
                {   'analyst_count': 29,
                    ...
                    'screener': {   'book_value': '220',
                                    ...
                                    'roce': '9.24',
                                    'roe': '7.35',
                                    'valuation_alerts': [   'Fails Current '
                                                            'Ratio (< 2.0)',
                                                            'Fails Debt Limit '
                                                            '(Debt > Net '
                                                            'Assets)',
                ...
                {   'analyst_count': 33,
                    ...
                    'ticker': 'ITC'}],
    'logistics_heavy_capital': [   {   'analyst_count': 17,
                                   ...
                                   {   'analyst_count': 23,
                                       ...
                                       'ticker': 'CUMMINSIND'}],
    'macro_indicators': [   {   'analyst_count': None,
                                'catalyst': 'Passive index fund tracking the '
                                            "broader GVA growth of India's "
                                            'manufacturing sector.',
                                'earnings_growth': None,
                                'growth_pct': None,
                                'name': 'ICICI Pru Nifty India Manufacturing '
                                        'ETF',
                                'price': '100.50',
                                'rating': 'N/A',
                                'rec_score': None,
                                'revenue_growth': None,
                                'screener': {   'market_cap': 'N/A',
                                                'pe_ratio': 'N/A',
                                                'roce': 'N/A',
                                                'roe': 'N/A',
                                                'valuation_alerts': []},
                            ...
                            {   'analyst_count': None,
                                ...
                                'target_median': None,
                                'ticker': 'HDFCMANETF'}],
    'manufacturing_electronics': [   {   'analyst_count': 29,
                                     ...
                                     {   'analyst_count': 19,
                                         ...
                                         'ticker': 'CGPOWER'}],
    'semiconductors_equipment': [   {   'analyst_count': None,
                                    ...
                                    {   'analyst_count': None,
                                        ...
                                        'target_median': None,
                                        'ticker': 'SPEL'}],
    'sports_athleisure': [   {   'analyst_count': 21,
                             ...
                             {   'analyst_count': 10,
                                 ...
                                 'ticker': 'RELAXO'}],
    'surveillance_security': [   {   'analyst_count': 4,
                                 ...
                                 {   'analyst_count': 12,
                                     ...
                                     'ticker': 'ZENSARTECH'}],
    'textiles_apparel': [   {   'analyst_count': 10,
...
SECTOR_METADATA = {   'aerospace_defence': {   'desc': 'Local aircraft assembly, BCD exemptions, '
                                     'and defense systems.',
                             'icon': '✈️',
                             'label': 'Aerospace & Defence'},
    'big_cap_industries': {   'desc': 'Nation-building conglomerates, heavy '
                                      'engineering, and infrastructure giants.',
                              'icon': '🏛️',
                              'label': 'Big Cap Industries'},
    'clean_energy': {   'desc': 'Solar, Wind, Green Hydrogen, and Grid '
                                'Transmission initiatives.',
                        'icon': '⚡',
                        'label': 'Clean Energy'},
    'cybersecurity': {   'desc': 'Data protection, software defense systems, '
                                 'and network security policies.',
                         'icon': '🛡️',
                         'label': 'Cybersecurity'},
    'data_center_support': {   'desc': 'Power cooling, high-speed fiber '
                                       'cables, and server space '
                                       'infrastructure.',
                               'icon': '🖥️',
                               'label': 'Data Center Support'},
    'fmcg': {   'desc': 'Rural disposable income, food processing, and '
                        'consumer product growth.',
                'icon': '🛒',
                'label': 'FMCG & Consumption'},
    'logistics_heavy_capital': {   'desc': 'Container manufacturing scheme, '
                                           'heavy machinery, and freight '
                                           'logistics.',
                                   'icon': '📦',
                                   'label': 'Logistics & Capital Goods'},
    'macro_indicators': {   'desc': 'Passive index funds and ETFs tracking '
                                    'sector GVA growth.',
                            'icon': '📊',
                            'label': 'Macro Indicators'},
    'manufacturing_electronics': {   'desc': 'PLI programs, semiconductor '
                                             'fabrications, and local contract '
                                             'assembly.',
                                     'icon': '🏭',
                                     'label': 'Manufacturing & Electronics'},
    'semiconductors_equipment': {   'desc': 'India Semiconductor Mission (ISM) '
                                            '2.0, silicon fabs, and OSAT '
                                            'plants.',
                                    'icon': '💾',
                                    'label': 'Semiconductors & Equipment'},
    'sports_athleisure': {   'desc': 'Active footwear, fitness apparel, and '
                                     'sports licensing brands.',
                             'icon': '👟',
                             'label': 'Sports & Athleisure'},
    'surveillance_security': {   'desc': 'Smart City CCTVs, border security '
                                         'systems, and commercial surveillance '
                                         'cameras.',
                                 'icon': '📷',
                                 'label': 'Surveillance & CCTV'},
    'textiles_apparel': {   'desc': 'Textile PLI programs, technical textiles, '
                                    'and global export hubs.',
                            'icon': '👕',
                            'label': 'Textiles & Apparel'}}

SECTOR_QUERIES = {   'aerospace_defence': [   'site:pib.gov.in "defence custom duty" OR '
                             '"defence aerospace"',
                             'India defense manufacturing offset policies HAL '
                             'BEL',
                             '"Hindustan Aeronautics" OR "Bharat Electronics" '
                             'OR "Astra Microwave" defence'],
    'big_cap_industries': [   'site:pib.gov.in "infrastructure" OR "capital '
                              'expenditure" OR "Gati Shakti"',
                              'India infra capex budget Larsen Toubro Reliance '
                              'industries',
                              'L&T order book Reliance green energy'],
    'clean_energy': [   'site:pib.gov.in "solar" OR "renewable" OR "green '
                        'hydrogen"',
                        'India clean energy policy ministry power',
                        '"Adani Green" OR "Tata Power" OR "Suzlon" energy '
                        'order'],
    'cybersecurity': [   'site:pib.gov.in "cyber security" OR "cybersecurity" '
                         'OR "CERT-In"',
                         'India cyber security policy enterprise network '
                         'protection',
                         'TCS Quick Heal cyber contracts'],
    'data_center_support': [   'site:pib.gov.in "data center" OR "digital '
                               'infrastructure"',
                               'India data center policy expansion investments',
                               '"Anant Raj" OR "Schneider" OR "Netweb" data '
                               'center'],
    'fmcg': [   'site:pib.gov.in "agriculture" OR "rural development" OR "food '
                'processing"',
                'India FMCG consumption rural demand inflation',
                'Varun Beverages ITC results shares'],
    'logistics_heavy_capital': [   'site:pib.gov.in "Container Scheme" OR '
                                   '"heavy logistics"',
                                   'India container manufacturing capital '
                                   'goods railway capex',
                                   '"CONCOR" OR "BHEL" OR "Cummins" logistics '
                                   'order'],
    'macro_indicators': [   'site:pib.gov.in "manufacturing GVA" OR '
                            '"industrial production"',
                            'India manufacturing growth index PMI index',
                            'Nifty India Manufacturing ETF shares'],
    'manufacturing_electronics': [   'site:pib.gov.in "PLI" electronics OR '
                                     '"semiconductor" OR "OSAT"',
                                     'India electronics manufacturing PLI '
                                     'scheme semiconductor fab',
                                     'Dixon Kaynes semiconductor factory'],
    'semiconductors_equipment': [   'site:pib.gov.in "semiconductor PLI" OR '
                                    '"ISM 2.0" OR "OSAT"',
                                    'India semiconductor fab equipment OSAT '
                                    'packaging plants',
                                    '"ASM Technologies" OR "RIR Power" OR '
                                    '"SPEL" semiconductor'],
    'sports_athleisure': [   'site:pib.gov.in "sports" OR "Khelo India" OR '
                             '"footwear PLI"',
                             'India sports brand athleisure market growth '
                             'campus footwear',
                             'Metro Brands Campus Activewear shares'],
    'surveillance_security': [   'site:pib.gov.in "CCTV" OR "safe city" OR '
                                 '"surveillance"',
                                 'India smart city CCTV cameras border defense '
                                 'drones',
                                 '"CP Plus" OR "Aditya Infotech" OR "Allied '
                                 'Digital" OR "IdeaForge" surveillance'],
    'textiles_apparel': [   'site:pib.gov.in "textile PLI" OR "apparel '
                            'manufacturing"',
                            'India textiles export incentives technical '
                            'textiles',
